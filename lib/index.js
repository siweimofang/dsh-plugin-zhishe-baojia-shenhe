...
import { parseQuoteText, parseQuoteJSON } from './quote_parser.js';
import { auditQuote, formatAuditReport } from './anomaly_engine.js';
  ...
  return {
    ...
    baojia_item_check: async (params) => {
      ...
      try {
        ...
        const benchmark = JSON.parse(readFileSync(join(__dirname, 'benchmark.json'), 'utf-8'));
